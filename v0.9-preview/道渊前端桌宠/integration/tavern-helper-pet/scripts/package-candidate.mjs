...
const importOutputPath = new URL('../../道渊小手机V0.9.json', projectRoot);
...
const candidate = {
  ...
  dataBoundary: {
    ...
    statDataWrites: ['stat_data.主角.储物袋', 'stat_data.主角.器物', 'stat_data.主角.极品灵石', 'stat_data.主角.上品灵石', 'stat_data.主角.中品灵石', 'stat_data.主角.下品灵石'],
...
const importableScript = {
  ...
  content: source,
  info: '道渊小手机 V0.9：万宝商行支持世界书物价货单、储物袋与器物一次性估价、独立交易事实注入开关、交易记录与货单删除、售罄保护、受限 MVU 写回及状态栏同步。',
  button: {
    enabled: false,
    buttons: [],
  },
