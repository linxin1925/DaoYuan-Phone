...
export const BridgeActionSchema = z.enum([
  ...
  'REQUEST_DLC_STATUS', 'DLC_STATUS_DATA', 'INSTALL_MISSING_DLCS', 'DLC_INSTALL_STATUS',
  'ATTACH_DLCS_TO_CURRENT_CHARACTER', 'DLC_ATTACH_STATUS', 'SAVE_DLC_SETTINGS', 'DLC_SETTINGS_STATUS',
  'CHECK_DLC_COMPATIBILITY', 'DLC_COMPATIBILITY_DATA', 'REPAIR_DLC_MISSING_ENTRIES', 'DLC_REPAIR_STATUS',
]);
